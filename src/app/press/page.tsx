...
export default function PressPage() {
  const content = (
    <>
      <p className="mb-4">
        Welcome to the e-MART press page. Here you'll find our latest press releases, media coverage, and company news.
      </p>
      ...
      <div className="space-y-6 mb-8">
        <div className="border-l-4 border-blue-500 pl-4">
          ...
          <h3 className="text-lg font-semibold mb-1">e-MART Launches New Mobile App with Enhanced Features</h3>
        ...
        <div className="border-l-4 border-blue-500 pl-4">
          ...
          <h3 className="text-lg font-semibold mb-1">e-MART Expands International Shipping to 25 New Countries</h3>
          <p className="text-gray-600 dark:text-gray-400">
        ...
        <div className="border-l-4 border-blue-500 pl-4">
          ...
          <h3 className="text-lg font-semibold mb-1">e-MART Commits to Carbon-Neutral Shipping by 2025</h3>
          <p className="text-gray-600 dark:text-gray-400">
      ...
      <p className="mb-4">
        For media inquiries, please contact our press team at press@e-mart.com or call (123) 456-7890. We're happy to provide:
      </p>
